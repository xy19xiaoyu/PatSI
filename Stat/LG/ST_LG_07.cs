...
{
    //技术生命周期
    public class ST_LG_07 : IStatAdapter
    {
        public ST_LG_07(string name, cfg config)
            : base(name, config)
        {
