...
namespace Stat.LG
{
    public class ST_LG_05 : IStatAdapter
    {
        public ST_LG_05(string name, cfg config)
            : base(name, config)
        {
        ...
        public override string GetStatSQL()
        {
            ...
            columns += string.Format(",{0}.{1} as '{2}'", Config.GroupLG.TableName, Config.GroupLG.ColName, Config.GroupLG.ShowName);
            groupby += string.Format(",{0}.{1}", Config.GroupLG.TableName, Config.GroupLG.ColName, Config.GroupLG.ShowName);



            tablenames.Add(Config.GroupLG.TableName);
            ...
            where += string.Format(" and {0}.{1} in({2})", Config.GroupLG.TableName, Config.GroupLG.ColName, Config.TopLG);
