...
namespace BLL.Index
{
    public class WPIIndex
    {
        ...
        public static STDT AutoIndex(ShowBase sb, out List<STPa> pa, out List<STIV> iv, out List<STIpc> ic, out List<STPR> pr, out List<STPNS> pn, out List<STAnS> an, out List<STDc> dc)
        {
